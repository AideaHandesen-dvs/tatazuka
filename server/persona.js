...
export const TABLES = {
  ...
  'sense.shake':     [['うわっ、揺らすなって！', '怒り'],
                      ['目が回る！　やめろ！', '怒り']],
  // 持ち上げる（§5-3 制定時からの語彙。初の送り手は IMU 付き物理ボディ＝connectors §3-3）
  'sense.lift':      [['うわっ、おい、下ろせ！', '怒り'],
                      ['た、高い…！　下ろせって！', '怒り']],

  // 受動の口（protocol §5-4 talk）。ルール表は内容を理解できない＝相槌の床。
  // LLM persona はここを ctx.text／ctx.history 込みの会話に格上げする
  'talk':[['ふーん。…で？', '通常'],
          ['へえ、そうか。', '通常'],
          ['ほう。…聞いてやってるぞ、一応。', '照れ'],
          ['そうかそうか。…まあ、頑張れ。', '呆れ']],
